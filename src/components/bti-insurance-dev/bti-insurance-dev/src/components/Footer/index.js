...
export const Footer = () => {
    return (
        <section className='footer-section bg-primary pt-5 lg:pt-20 pb-10 relative'>
            ...
            <div className='container mx-auto'>
                <div>
                    <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
                        <div className='footer-col-1 px-5'>
                            <div className='footer-logo text-left px-5'>
                                <img src={Logo} alt='BTI Insurance' className='w-3/4' />
                            </div>
                            <div className='flex items-center mt-10 pl-7'>
                        ...
                        <div className='footer-col-2 px-5'>
                            <h4 className='text-white font-semibold text-xl'>Contact</h4>
                            <div className='footer-details mt-10'>
                                <p className='text-muted '>
                                    <a href='mailto:info@btiinsurance.com' className='text-muted flex items-center'>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                        </svg>

                                        <span className='ml-3'>info@btiinsurance.com</span>
                                    </a>
                                </p>
                                <p className='text-muted'>
                                    <a href='tel:+34624411955' className='text-muted flex items-center'>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                                ...
                                <p className='text-muted flex items-center'>
                                    ...
                                    <span className='ml-3'>
                                        Avenida Isidor Macabich 1 07816,San Rafael, Ibiza, Balearic Islands
                                    </span>
                                </p>
                            </div>
                        </div>
                        <div className='footer-col-3 px-5'>
                            ...
                            <div className='footer-details mt-10'>
                                <p className='text-muted flex items-center'>
                                    ...
                                    <span className='ml-3'>Mon – Fri: 9:00 am to 5:00 pm</span>
                                </p>
                                <p className='text-muted flex items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                ...
                <div className='copyright-section border-t  mt-10 lg:mt-20 text-muted'>
                    <p className='text-muted text-center pt-8'>© All Copyright 2023 by BTI Insurance</p>
                </div>
            </div>
        </section>
    )
