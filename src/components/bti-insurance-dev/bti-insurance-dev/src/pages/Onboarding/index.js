...
export const LawyerOnboarding = () => {
    let endPoint = siteConfig.endpoint.signUp;
    ...
    const data = {
        i : 99967,
        d : "{\"i\": \"0.0.0.0\",\"u\": \"vicky\",\"c\": \"999888\"}",
        p : 'eyJlbWFpbCIgOiAidXNlcl9lbWFpbF8wMDM0QGdtYWlsLmNvbSIsICJwYXNzd29yZCIgOiAiQUAxcGFzc3dvcmQiLCAgIm5hbWUiIDogInVzZXIwMDM0IiwgInJvbGUiIDogImxhd3llciIgfQ=='
    }
    const callApi = () => {
        // alert(enc);
            ...
            <section className='pt-20 pb-40'>
                <div className='container mx-auto'>
                    <div className='section-title text-center mt-10'>
                        <h6 className='font-semibold  text-md'>ON-BOARDING</h6>
                        <h4 className='font-bold text-primary text-4xl mt-1'>Lawyer<span className=' text-blue'> On-Boarding</span></h4>
                    </div>
